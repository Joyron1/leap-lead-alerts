...
- Payouts are small: over the first 10 days, 159 of 265 accepted leads paid ≤$0.60 and only 4 paid over $10. That is why the immediate alert has a threshold and the 🔥 marks start at $5/$10/$20 (1/2/3 marks) and then, per the owner's 2026-09-18 spec, count one mark per $10 from $40 (4) to $100 (10). Accepted-lead headlines also carry the payout (`ליד חדש – ACCEPTED – $27.80`). The scale lives in `fireMarks()` in both `lead-alert` and `leap-sync`; change both together.
