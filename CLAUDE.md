...
- Never hardcode secrets. Names: `TELEGRAM_BOT_TOKEN`, `TELEGRAM_CHAT_ID`, `LEAP_USER`, `LEAP_PASS`, `GSC_SA_JSON`, `ANTHROPIC_API_KEY` (optional `SUMMARY_TZ`, `SUMMARY_HOUR`, `ALERT_KEY`, `GSC_PROPERTY`, `KEYWORD_SHEET_ID`).
